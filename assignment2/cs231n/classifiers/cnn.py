...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        conv_out_h=num_filters*H*W//4

        self.params['W2']=np.random.normal(0.0,weight_scale,(conv_out_h,hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dmidscr,grads['W3'],grads['b3']=affine_backward(dscore,cache5)
        dx2,grads['W2'],grads['b2']=affine_relu_backward(dmidscr,cache4)

        dx1=max_pool_backward_fast(dx2,cache3)
        dx0=relu_backward(dx1,cache2)
        _,grads['W1'],grads['b1']=conv_backward_fast(dx0,cache1)
